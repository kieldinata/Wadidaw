...
<head>
    ...
    <style>
        ...
        h1 { color: #ffffff; border-bottom: 2px solid #e50914; padding-bottom: 10px; margin-bottom: 5px; }
        ...
        .api-name { font-weight: bold; color: #fff; font-size: 1.1rem; display: block; }
        .api-tag {
        ...
        .status-up { color: #46d369; font-size: 0.8rem; }

        @media (max-width: 768px) {
            .header-container { left: 20px; top: 15px; }
            .logo-wadidaw { height: 45px; }
            body { padding: 100px 20px 40px 20px; }
        }
    </style>
</head>
<body>
